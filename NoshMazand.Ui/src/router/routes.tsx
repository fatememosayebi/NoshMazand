...
const Doc_SendDocs = lazy(() => import('@/pages/Document/SendDocs'));
const Doc_Upload = lazy(() => import('@/pages/Document/UploadDocs'));

const Companies = lazy(() => import('@/pages/companies/Company'));
const Create_Companies = lazy(() => import('@/pages/companies/CreateCompany'));
...
const routes = [
    ...
    {
        path: '/Proforma/:fileNo/Document/SendDocs',
        element: <Doc_SendDocs />,
    },
    {
        path: '/Proforma/:fileNo/Document/Upload',
        element: <Doc_Upload />,
    },
