                ...
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                        <Link to="/" className="main-logo flex items-center shrink-0">
                            ...
                            <GiCutDiamond className="ltr:-ml-1 rtl:-mr-1 text-3xl mx-auto text-primary shadow-primary/60" />
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-thin  align-middle hidden md:inline dark:text-white-light transition-all duration-300">الماس</span>
                        </Link>
                        <button
                            type="button"
                                ...
                                <ul className="!py-0 text-dark dark:text-white-dark w-[300px] sm:w-[375px] text-xs">
                                    <li className="mb-5" onClick={(e) => e.stopPropagation()}>
                                        <div className="hover:!bg-transparent overflow-hidden relative rounded-t-md p-5 text-white w-full !h-[68px]">
                                            ...
                                            ></div>
                                            <h4 className="font-semibold relative z-10 text-lg">پیغام ها</h4>
                                        </div>
                                    </li>
                                    {messages.length > 0 ? (
                                        <>
                                            ...
                                            <li className="border-t border-white-light text-center dark:border-white/10 mt-5">
                                                <button type="button" className="text-primary font-semibold group dark:text-gray-400 justify-center !py-4 !h-[48px]">
                                                    <span className="group-hover:underline ltr:mr-1 rtl:ml-1">نمایش همه</span>
                                                    <svg
                                        ...
                                        <div className="flex items-center px-4 py-4">
                                            ...
                                            <div className="ltr:pl-4 rtl:pr-4">
                                                <h4 className="text-base">
                                                    نام کاربر
                                                    <span className="text-xs bg-success-light rounded text-success px-1 ltr:ml-2 rtl:ml-2">حاضر</span>
                                                </h4>
